#!/bin/bash
#$ -l mem_free=80G,h_vmem=80G,h_fsize=80G
...
fname='/dcs04/lieber/marmaypag/spatialDLPFC_SCZ_LIBD4100/raw-data/images/RealPNN/5_Real_PNN_Slide4/V13M06-279.mat'

toolbox='/dcs04/lieber/marmaypag/spatialDLPFC_SCZ_LIBD4100/code/vistoseg/lib_updated/'
matlab -nodesktop -nosplash -nojvm -r "addpath(genpath('$toolbox')), splitSlide_IF_offset_V13M06_279('$fname')" 