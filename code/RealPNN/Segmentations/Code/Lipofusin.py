...
dst_dir_af = '/dcs04/lieber/marmaypag/spatialDLPFC_SCZ_LIBD4100/processed-data/RealPNN/single_channels_segmented/AF/slide16/'
...
for img_path in os.listdir(source_dir):
    if img_path.endswith(".tif") and ('V13F27-336') in img_path:
        ...
        af_cnt = cv2.drawContours(af_c, af_contours, -1, (0, 0, 0), 1)
        ...
        cv2.imwrite(dst_dir_af + img_path.split('.')[0] + '_af_binarized.tif', thresh_segmented)
