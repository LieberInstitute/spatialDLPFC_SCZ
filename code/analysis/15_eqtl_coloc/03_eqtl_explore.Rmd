...
if (file.exists(fgwas)) {
  ...
  if (file.exists(fgwas38)) {
    ...
    ## if beta>0 then A1 is the EFFECT allele (A2 is protective)
    ## if beta<0 then A2 is the EFFECT allele (A1 is protective).
  ...
  ### NOTE: in gwas_wide, a0 = effect reference allele (former A1), a1 = other allele (former A2)
  ## harmonize with tensorqtl variant universe (i.e. pvar REF ALT, not necessarily genomic REF ALT)
