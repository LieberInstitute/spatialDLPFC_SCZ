...
plot_eQTL_boxplots <- function(plotdata, eqtl_pairs, use_raw = FALSE, restrict_donors = NULL, title = "auto", gwas_eff = FALSE, ds = NULL) {
  ...
  # anchor annotation to panel bottom-right (edge coordinates)
  ...
  if (all(!is.na(annot_dt$beta))) {
    p <- p + geom_text(data = annot_dt,
                       ...
                       hjust = 1.2, vjust = -0.2, size = 3, inherit.aes = FALSE)
  }
...
#print(plot_eQTL_boxplots(npil_plotdata, ieqtls, title=ds2name[ds], gwas_eff = TRUE))
```
