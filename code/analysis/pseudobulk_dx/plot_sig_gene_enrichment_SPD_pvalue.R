# Deprecated
## After talking to I realize that these heatmap doesn't show directionality and hence is not as good to visualize the results. 

# Enrichment means that they are more expressed in one "domain" spatial domain or cell type than the other ones.
