...
for file in files:    
    ...
    img_channels = ['DAPI', 'NeuN', 'Claudin5', 'WFA', 'Autofluorescence', 'tpoint', 'ostus', 'adapT', 'AFmask', 'filt']
    default_channels = {'red': 'WFA', 'white': 'tpoint', 'white': 'ostus', 'white': 'adapT' , 'white': 'AFmask', 'white':'filt'}
