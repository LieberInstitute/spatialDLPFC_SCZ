...
this_donor = "Br2719"
#Br8667 #Br5973
samui_dir = Path(here('processed-data', 'image_processing', 'samui_spotCalling', this_donor))
...
spotCalling_df = spgP.obs[['PNN', 'DAPI', 'NeuN', 'Claudin']]
spotCalling_metrics = spgP.obs[['NDAPI', 'PDAPI', 'IDAPI', 'CNDAPI',
       'NNeuN', 'PNeuN', 'INeuN', 'CNNeuN', 'NWFA', 'PWFA', 'IWFA', 'CNWFA',
       'NClaudin5', 'PClaudin5', 'IClaudin5']]

################################################################################
#   Use the Samui API to create the importable directory for this combined "sample"
################################################################################
img_channels = ['Claudin5', 'Autofluorescence', 'DAPI', 'NeuN', 'WFA']
default_channels = {'blue': 'DAPI', 'green': 'NeuN', 'white': 'Claudin5', 'red': 'WFA', 'cyan': 'Autofluorescence'}
img_path = Path(here('processed-data', 'VistoSeg', 'captureAreas',f'{unique_sample_id}.tif'))
